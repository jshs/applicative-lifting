...
apply(rule monoid_add.homomorphism monoid_add.B_conv monoid_add.interchange)+
...
apply(rule monoid_add.homomorphism monoid_add.B_conv monoid_add.I_conv)+
